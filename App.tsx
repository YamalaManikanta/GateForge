...
import MockTracker from './src/components/MockTracker';
import ErrorLog from './src/components/ErrorLog';
import DailyTracker from './src/components/DailyTracker';
import StrategySimulator from './src/components/StrategySimulator';
import SubjectYield from './src/components/SubjectYield';
import Welcome from './src/components/Welcome';
import DataControl from './src/components/DataControl';
import SyllabusInfo from './src/components/SyllabusInfo';
import SyllabusTracker from './src/components/SyllabusTracker';
import CalendarView from './src/components/CalendarView';
import VirtualCalculator from './src/components/VirtualCalculator';
import FlashcardDeck from './src/components/FlashcardDeck';
import CodeRunner from './src/components/CodeRunner';
import Gauntlet from './src/components/Gauntlet';
